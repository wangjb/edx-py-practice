...
#
# .. your code here ..
mat = scipy.io.loadmat('D:/DAT210x-master/Module4/Datasets/face_data.mat')
...
#
# .. your code here ..
label = pd.read_csv('D:/DAT210x-master/Module5/Datasets/face_labels.csv',header=None)
label = label[0]
...
#
# .. your code here ..
knn = KNeighborsClassifier(n_neighbors=20).fit(data_train,label_train)
