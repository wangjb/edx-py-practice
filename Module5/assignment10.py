...
# .. your code here ..
zero = []
for record in glob.glob('D:/DAT210x-master/Module5/Datasets/free-spoken-digit-dataset-master/recordings/0_jackson*.wav'):
    sample_rate, data = wavfile.read(record)
    zero.append(data)
...
wavfile.write('D:/DAT210x-master/Module5/Datasets/free-spoken-digit-dataset-master/recordings/Original Test Clip.wav', sample_rate, test)
...
#
# .. your code here ..
X_test = test[0:int(round(Provided_Portion * n_audio_samples))]
...
#
# .. your code here ..
y_test = test[int(round(Provided_Portion * n_audio_samples)):]
...
#
# .. your code here ..
X_train = train[:,0:int(round(Provided_Portion * n_audio_samples))]
y_train = train[:,int(round(Provided_Portion * n_audio_samples)):]
...
wavfile.write('D:/DAT210x-master/Module5/Datasets/free-spoken-digit-dataset-master/recordings/Extrapolated Clip.wav', sample_rate, completed_clip[0])
