...
#
# .. your code here ..
X = pd.read_csv('D:/DAT210x-master/Module5/Datasets/College.csv',index_col=0)
...
#
# .. your code here ..
X_train, X_test, y_train, y_test = train_test_split(X[['Room.Board','F.Undergrad']], X[['Accept']], test_size=0.3, random_state=7)
model.fit(X_train,y_train)
score = model.score(X_test,y_test)
