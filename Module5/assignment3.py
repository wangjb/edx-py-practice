...
def doKMeans(data, clusters=0):
  ...
  print centroids
  ax.scatter(centroids[:,0],centroids[:,1], c='r', marker='o')
  return model
...
#
# .. your code here ..
df = pd.read_csv('K:/DAT210x-master/Module5/Datasets/CDR.csv')
...
#
# .. your code here ..
    user1 = user1[pd.DatetimeIndex(user1['CallDate']).weekday < 6]
...
#
# .. your code here ..
    user1 = user1[(user1['CallTime'] < pd.to_timedelta('17:00:00'))]
