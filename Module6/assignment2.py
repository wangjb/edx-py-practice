...
X_train, X_test, y_train, y_test = load('D:/DAT210x-master/Module6/Datasets/optdigits.tes', 'D:/DAT210x-master/Module6/Datasets/optdigits.tra')
...
svc = SVC(kernel='rbf', C=1, gamma=0.001).fit(X_train, y_train)
...
#
# .. your code here ..
guess_1000th_test_value = svc.predict(X_test.ix[999].values.reshape(1,-1))
