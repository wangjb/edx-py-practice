...
mat = scipy.io.loadmat('K:/DAT210x-master/Module4/Datasets/face_data.mat')
...
pca.fit(df)
T = pca.transform(df)
Plot2D(T, "PCA Result", 1, 2, num_to_plot=40)
...
iso = manifold.Isomap(n_neighbors=4, n_components=8)
iso.fit(df)
manifold = iso.transform(df)
Plot2D(manifold, "ISOMAP Result", 1, 2, num_to_plot=40)
...
Plot3D(manifold, "ISOMAP Result", 0, 1, 2, num_to_plot=40)
